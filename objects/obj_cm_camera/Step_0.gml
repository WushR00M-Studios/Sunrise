if cancelout == false {
	...
	// controller panning
	if (InputCheck(INPUT_VERB.RJOY_LEFT))  cam_x_target -= 4 / zoom;
	if (InputCheck(INPUT_VERB.RJOY_RIGHT)) cam_x_target += 4 / zoom;
	if (InputCheck(INPUT_VERB.RJOY_UP))    cam_y_target -= 4 / zoom;
	if (InputCheck(INPUT_VERB.RJOY_DOWN))  cam_y_target += 4 / zoom;
